                    ...
                    <div className="footer">
                        ...
                        <div className="star-dis">
                            <img className="str-btn" 
                                ...
                                onClick={()=>{this.props.remStars(this.props.movies)}}
                            />
                            <img className="stars" 
                                    alt="stars" 
                        ...
                        <button className={fav?"unfavourite-btn":"favourite-btn"}  onClick={()=>{this.props.toggleFav(this.props.movies)}}>
                        ...
                        <button className={isInCart?"unfavourite-btn":"cart-btn"}     onClick={()=>{this.props.toggleCart(this.props.movies)}}>
